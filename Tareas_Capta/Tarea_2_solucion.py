...
print(f"El largo de la lista es de {largo_lista}")
print("")
...
for elemento in lista:
    ...
    elif type(elemento) is bool:
        booleans.append(elemento)
    elif type(elemento) is str:
        strings.append(elemento)
    elif elemento == None:
        nones.append(elemento)
    #else:
    #    nones.append(elemento)

# Parte 3:
print(f"Se encontrar {len(enteros)} elementos de la sublista enteros")
print(f"Se encontrar {len(decimales)} elementos de la sublista decimales")
print(f"Se encontrar {len(booleans)} elementos de la sublista booleans")
print(f"Se encontrar {len(strings)} elementos de la sublista strings")
print(f"Se encontrar {len(nones)} elementos de la sublista nones")
print("")
# print(len(enteros)+len(decimales)+len(booleans)+len(strings)+len(nones))

# Parte 4 y 5:
print(f"El minimo de la lista de enteros es {min(enteros)}")
print(f"El maximo de la lista de enteros es {max(enteros)}")
print(f"La suma de todos los enteros es {sum(enteros)}")
print("")

# Parte 6 y 7:
print(f"El minimo de la lista de decimales es {min(decimales)}")
print(f"El maximo de la lista de decimales es {max(decimales)}")
print(f"La suma de todos los decimales es {sum(decimales)}")
print("")

# Parte 8 y 9: strings cortos y largos
aux_strings = []

for string in strings:
    aux_strings.append([len(string), string])
aux_strings.sort()
# print(aux_strings)

string_mas_corto = aux_strings[0]
string_mas_largo = aux_strings[-1]
print(f"El string mas corto es {string_mas_corto[1]} con un largo de {string_mas_corto[0]}")
print(f"El string mas largo es {string_mas_largo[1]} con un largo de {string_mas_largo[0]}")
print("")

# Parte 10: bonus
largo_max = len(booleans)

lista_nueva = enteros[0:largo_max] + decimales[0:largo_max] + booleans + strings[0:largo_max] + nones[0:largo_max]

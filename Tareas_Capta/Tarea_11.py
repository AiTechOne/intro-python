# Tarea: concatena las palabras de la lista 'palabras' en una sola variable de tipo string.
# Ojo que las palabras tienen mayusculas y minusculas en lugares donde no debería. Formatea el texto
# para que solamente la primera palabra del texto y las siguientes después de un punto sean mayúsculas.
